...
/* Sample's Logic */
doca_error_t pslist(const char *dma_device_name, const char *pci_addr, enum doca_apsh_system_os os_type);
...
main(int argc, char *argv[])
{
	...
	result = pslist(apsh_conf.dma_dev_name, apsh_conf.pci_addr, apsh_conf.os_type);
	if (result != DOCA_SUCCESS) {
